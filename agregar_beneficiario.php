<?php
    ...
    $numero_contrato = $_GET['superdato2'];
	...
	<div class = "container mi_cont">
    	...
    	<div class = "row justify-content-center mi_row">
			<div class = "col-12 mi-col table-responsive">
				<!-- (row_!Centro!) -->
                <form name="" method="post" action="scripts/agregar_beneficiario.php"> 
                    <table class="table table-striped">
                        <thead class="thead-light">
                            <tr>
                                <th colspan="4">Agregar Beneficiario:</th>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <span class="lead text-info">
                                    Ingrese los datos del nuevo beneficiario asociado a la credencial <?php echo $credencial;?> adendum del contrato <?php echo $numero_contrato;?>.
                                    </span>
                                </td>
                            </tr>
                        </thead>
                        <tr>
                            <td colspan="4">
                                <span class="text-danger">
                                    <?php echo $_SESSION['BENEFICIARIO_ERROR'];?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td>Credencial:</td>
                            <td> 
                                <input name="credencial" type="text" value="<?php echo $credencial;?>" id="credencial" size="" maxlength="25" readonly>
                            </td>
                            <td>N&uacute;mero de contrato:</td>
                            <td>
                                <input name="numero_contrato" id="numero_contrato" value="<?php echo $numero_contrato;?>" size="" maxlength="25" readonly></input>
                            </td>
                        </tr>
                        <tr>
                            <td>*Nombre Beneficiario:</td>
                            <td> 
                                <input name="nombre" type="text" id="nombre" value="<?php echo $_SESSION['BENEFICIARIO_TEMP_3']; ?>" size="" maxlength="100">
                            </td>
                            <td>*C&eacute;dula identidad:</td>
                            <td>
                                <input name="cedulaA" id="cedulaA" value="<?php echo $_SESSION['BENEFICIARIO_TEMP_4A']; ?>" size="1" maxlength="1"></input>
                                <input name="cedulaB" id="cedulaB" value="<?php echo $_SESSION['BENEFICIARIO_TEMP_4B']; ?>" size="1" maxlength="4"></input>
                                <input name="cedulaC" id="cedulaC" value="<?php echo $_SESSION['BENEFICIARIO_TEMP_4C']; ?>" size="1" maxlength="4"></input>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input name="cedulaR" id="cedulaR" value="<?php echo $_SESSION['BENEFICIARIO_TEMP_4D']; ?>" size="20" maxlength="20"></input>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="telefono_movil" id="telefono_movil" value="<?php echo $_SESSION['BENEFICIARIO_TEMP_5']; ?>" size="" maxlength="12"></input>
                            </td>
                            <td>*Tel&eacute;fono Fijo:</td>
                            <td>
                                <input name="telefono_fijo" id="telefono_fijo" value="<?php echo $_SESSION['BENEFICIARIO_TEMP_6']; ?>" size="" maxlength="12"></input>
                            </td>
                        </tr>
                        <tr>
                            <td>*Provincia:</td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <input name="direccion_exacta" id="direccion_exacta" value="<?php echo $_SESSION['BENEFICIARIO_TEMP_9']; ?>" size="65" maxlength="200"></input>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <textarea id="observaciones" name="observaciones" rows="4" cols="63"><?php echo $_SESSION['BENEFICIARIO_TEMP_12']; ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <tr>
                                    <td colspan="4"><p class="text-center"><a href="editar_beneficiarios_1.php?superdato=<?php echo $credencial;?>&superdato2=<?php echo $numero_contrato;?>">Volver</a></p></td>
                            </tr>
                    </table>
                </form>
            </div>
