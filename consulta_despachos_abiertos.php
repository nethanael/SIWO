<?php
    ...
    tiempo_hospital FROM despachos WHERE estado LIKE 'ABIERTO'";                                          // Consulta del campo necesario
                                    ...
                                    foreach ($line as $campo => $col_value)
                                        {
                                            if ($campo == 'codigo_despacho'){
                                                echo "<td><a href=intervenir_despacho.php?superdato=",$col_value,">$col_value</a></td>";
                                            }
                                            if ($campo != 'codigo_despacho'){
