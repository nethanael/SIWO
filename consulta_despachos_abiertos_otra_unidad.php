<?php
    ...
    tiempo_hospital FROM despachos WHERE estado LIKE 'ABIERTO' AND unidad NOT LIKE '$unidad'";                                          // Consulta del campo necesario
			...
			<div class = "table-responsive">
                ...
                <table class="table table-sm table-striped">
                    <thead class="thead-light">
                        <tr>
                            <th colspan="19">Despachos abiertos para otras unidades:</th>
                        </tr>
                        <tr>
                            <td colspan="19"><small>Estos despachos no se pueden intervenir por esta unidad.</small></td>
                        </tr>
                    </thead>
                    <tr>
