<?php
    ...
    tiempo_hospital, tiempo_cierre FROM despachos WHERE estado LIKE 'CERRADO' AND unidad LIKE '$unidad'";                                         // Consulta del campo necesario
			...
			<div class = "table-responsive">
                ...
                <table class="table table-sm table-striped">
                    <thead class="thead-light">
                        <tr>
                            <th colspan="19">Despachos de unidad abiertos en este momento:</th>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        ...
                        <th><small>Tiempo Cierre:</small></th>
                        <th><small>Tiempo Total de atención:</small></th>	
                    </tr>
                                    ...
                                    foreach ($line as $campo => $col_value)
                                        {
                                            if ($campo == 'codigo_despacho'){
                                                echo "<td><a href=scripts/consultar_despacho.php?superdato=",$col_value,">$col_value</a></td>";
                                            }
                                            if ($campo != 'codigo_despacho'){
                                            ...
                                            if ($campo == 'tiempo_llamada'){
                                                $tiempo_llamada = $col_value;
                                            }

                                            if ($campo == 'tiempo_cierre'){
                                                $tiempo = dateDifference($col_value,$tiempo_llamada);
