<?php
	...
	$sql = "SELECT * FROM beneficiarios_credencial 
        ...
        <div class = "row justify-content-center mi_row">
            ...
            <table class="table table-sm table-striped">
                    <thead class="thead-light">
                        ...
                        <tr>
                            <td colspan="19"><a href="agregar_beneficiario.php?superdato=<?php echo $credencial;?>&superdato2=<?php echo $numero_contrato;?>">Agregar un Beneficiario</a></td>
                        </tr>
                        <tr>
                            <td colspan="19"><small>Haga click en el c&oacute;digo de beneficiario para editarlo.</small></td>
                        </tr>
                    </thead>
                    <tr>
                            ...
                            while ($line =  $resul->fetch_assoc()) 
                                {
                                    ...
                                    foreach ($line as $campo => $col_value)
                                        {
                                            if ($campo == 'codigo_sistema'){
                                                echo "<td><a href=editar_beneficiarios_2.php?superdato=",$col_value,">$col_value</a></td>";
                                            }
                                            if ($campo != 'codigo_sistema'){
            ...
            <a href="editar_credencial_2.php?superdato=<?php echo $credencial;?>">Volver</a>
        </div>
