			...
			<div class = "col-8 mi_col">
                ...
                <table class="table table-sm table-striped">
                    <thead class="thead-light">
                        <tr>
                            <th colspan="19">Datos de cobro de importancia:</th>
                        </tr>
                        <tr>
                            <td colspan="19"><small>Esto eliminar&iacute;a toda la informaci&oacute;n de credencial principal, beneficiarios y datos de cobro asociados a la misma.</small></td>
                        </tr>
                    </thead>
                    <tr>
                ...
                <div class = "col-12 mi_col table-responsive">
                    <table class="table table-sm table-bordered">
                        ...
                        <tr>
                            <td colspan="3"class="table-danger"><h3><a href="scripts/eliminar_credencial.php?superdato=<?php echo $credencial;?>">Eliminar</a></h3></td> 
                            <td colspan="3"class="table-danger">Atenci&oacute;n: esta acci&oacute;n no se puede deshacer.</td>
                        </tr>
                        <tr>
