				...
				<!-- (row_!Centro!) -->
					<table class="table">
						<thead class="thead-light">
							<tr>
								<th colspan="4"><p class="text-center h5">Men&uacute; Principal (Despacho):</p></th>
							</tr>
						</thead>
						<tr>
							<td colspan="2"><p class="text-center"><a class="btn btn-success" href="consulta_despacho.php">Consultar Credencial y Despachar</a></p></td>
							<td colspan="2"><p class="text-center"><a class="btn btn-success" href="despachar_unidad_A.php">Despachar Unidad sin Credencial</a></p></td>
						</tr>
						<tr>
							<td colspan="2"><p class="text-center"><a class="btn btn-success" href="consulta_despachos_abiertos.php">Despachos Activos (intervenci&oacute;n)</a></p></td>
							<td colspan="2"><p class="text-center"><a class="btn btn-success" href="consulta_despachos_cerrados.php"> Historial de Despachos Cerrados</a></p></td>
						</tr>
						<tr>
