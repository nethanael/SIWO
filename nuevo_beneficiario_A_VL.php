	...
	<div class = "container mi_cont">
    	...
    	<div class = "row justify-content-center mi_row">
			<div class = "col-8 mi_col">
				<!-- (row_!Centro!) -->
                <form name="" method="post" action="scripts/nuevo_beneficiario_VL.php"> 
                    <table class="table table-striped">
                        <thead class="thead-light">
                            ...
                            <tr>
                                <td colspan="4">
                                    ...
                                    Ingrese los datos del nuevo beneficiario asociado a la credencial <?php echo $_SESSION['CREDENCIAL'];?> adendum del contrato <?php echo $_SESSION['NUMERO_CONTRATO'];?>.
                                    </span>
                                </td>
                            </tr>
                        </thead>
                        ...
                        <tr>
                            <td>Credencial:</td>
                            <td> 
                                <input name="credencial" type="text" value="<?php echo $_SESSION['CREDENCIAL'];?>" id="credencial" size="" maxlength="25" readonly>
                            </td>
                            <td>N&uacute;mero de contrato:</td>
                            <td>
                                <input name="numero_contrato" id="numero_contrato" value="<?php echo $_SESSION['NUMERO_CONTRATO'];?>" size="" maxlength="25" readonly></input>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1">Afiliado Principal:</td>
                            <td colspan="3">
                                <input type="" value="<?php echo $_SESSION['AFILIADO'];?>" size="" maxlength="100" readonly>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="telefono_movil" id="telefono_movil" value="<?php echo $_SESSION['BENEFICIARIO_TEMP_5']; ?>" size="" maxlength="30"></input>
                            </td>
                            <td>*Tel&eacute;fono Fijo:</td>
                            <td>
                                <input name="telefono_fijo" id="telefono_fijo" value="<?php echo $_SESSION['BENEFICIARIO_TEMP_6']; ?>" size="" maxlength="30"></input>
                            </td>
                        </tr>
                        <tr>
                            <td>*Provincia:</td>
