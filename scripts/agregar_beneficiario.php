<?php
	...
	$antecedentes_medicos = $respiratorio . $cardipatias . $neuronales . $hepaticas . $endocrinas . $gastro_intestinales . $psiquiatricas;
    ...
    if ($credencial == '' || $numero_contrato == '' || $nombre == '' || $fecha_nacimiento == '' || $genero == '' || $telefono_fijo == '' || $telefono_movil == '' || $provincia == '' || $canton == '' || $distrito == '' || $direccion_exacta == '') 
	{
		...
		$myheader = "Location: ../agregar_beneficiario.php?superdato=".$credencial."&superdato2=".$numero_contrato;
		header($myheader);
	}
	else
	{
	...
	<div class = "container mi_cont">
    	...
    	<div class = "row justify-content-center mi_row">
			<div class = "col-12 mi-col table-responsive">
				<!-- (row_!Centro!) -->
				<span class="text-center"><h3>Nuevo beneficiario agregado</h3></span>
				<table class="table table-bordered">
					<tr>
						<td></td>
						<td>Beneficiario agregado con &eacute;xito por <?php echo $_SESSION['NOMBRE'];?></td>
						<td></td>
					</tr>
                    <tr>
						<td></td>
						<td><a href="../editar_beneficiarios_1.php?superdato=<?php echo $credencial;?>&superdato2=<?php echo $numero_contrato;?>">Volver</a></td>
						<td></td>
					</tr>
				</table>
			</div>
