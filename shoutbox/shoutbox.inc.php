...
session_start(); // Pablo Hidalgo agregó esto para usar sesiones globales en el shoutbox
...
<td>
	...
	<td align="right"><input type="text" name="sbName" maxlength="20" class="cssShoutForm" value=<?php echo $_SESSION['NOMBRE']; ?> style="width:<?php echo round($boxWidth * 0.65); ?>px" readonly></td>
	</tr><tr>
<?php
	if(!$hideEmail) {
?>
